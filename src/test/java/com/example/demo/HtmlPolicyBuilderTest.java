...
public class HtmlPolicyBuilderTest {
    
    final String EXAMPLE = Joiner.on('\n').join(
            "<h1 id='foo'>Header</h1>",
    ...
    @Test
    public void testCannedFormattingTagFilterNoItalics() {
        Assert.assertEquals(
                Joiner.on('\n').join(
                        "Header",
                        "Paragraph 1",
    ...
    @Test
    public void testExternalLinksAllowed() {
        Assert.assertEquals(
                Joiner.on('\n').join(
                        "Header",
                        "Paragraph 1",
    ...
    @Test
    public void testLinksWithNofollow() {
        Assert.assertEquals(
                Joiner.on('\n').join(
                        "Header",
                        "Paragraph 1",
    ...
    @Test
    public void testLinksWithNofollowAlreadyPresent() {
        Assert.assertEquals(
    ...
    @Test
    public void testStyleFiltering() {
        Assert.assertEquals(
                Joiner.on('\n').join(
                        "<h1>Header</h1>",
                        "<p>Paragraph 1</p>",
    ...
    @Test
    public void testElementTransforming() {
        Assert.assertEquals(
                Joiner.on('\n').join(
    ...
    @Test
    public void testBodyTransforming() {
        Assert.assertEquals(
                "<div>foo</div>",
                apply(
                        new HtmlPolicyBuilder()
    ...
    @Test
    public void testPossibleFalloutFromIssue5() {
        Assert.assertEquals(
                "Bad",
                apply(
                        new HtmlPolicyBuilder()
    ...
    @Test
    public void testImgSrcsetSyntax() {
        Assert.assertEquals(
                ""
    ...
    @Test
    public void testUrlChecksLayer() {
        Assert.assertEquals(
                ""
    ...
    @Test
    public void testDuplicateAttributesDoNotReachElementPolicy() {
    ...
    @Test
    public void testBackgroundImageWithUrl() {
        ...
        String expected =
                "<div style=\""
                        ...
                        + "url(&#39;http://example.com/foo.png&#39;)"
                        + "\">div content</div>";
        Assert.assertEquals(expected, safeHtml);
    }
    
    @Test
    public void testBackgroundImageWithImageFunction() {
        PolicyFactory policy = new HtmlPolicyBuilder()
                .allowStandardUrlProtocols()
                .allowStyling()
                .allowUrlsInStyles(AttributePolicy.IDENTITY_ATTRIBUTE_POLICY)
    ...
    @Test
    public void testBackgroundWithUrls() {
        ...
        Assert.assertEquals(safeWithoutUrls, noUrlsPolicy.sanitize(unsafeHtml));
        Assert.assertEquals(safeWithUrls, urlsPolicy.sanitize(unsafeHtml));
    }
    
    @Test
    public void testBackgroundsThatViolateGlobalUrlPolicy() {
        PolicyFactory policy = new HtmlPolicyBuilder()
                .allowStandardUrlProtocols()
                .allowStyling()
                .allowElements("div")
        ...
        Assert.assertEquals(safeHtml, policy.sanitize(unsafeHtml));
        
    }
    
    @Test
    public void testSpanTagFilter() {
        PolicyFactory policy = new HtmlPolicyBuilder()
                .allowElements("span")
    ...
    @Test
    public void testLinkRelsWhenRelPresent() {
    ...
    @Test
    public void testFailFastOnSpaceSeparatedStrings() {
        boolean failed;
        try {
    ...
    @Test
    public void testEmptyDefaultLinkRelsSet() {
        PolicyFactory pf = new HtmlPolicyBuilder()
                .allowElements("a")
    ...
    @Test
    public void testExplicitRelsSkip() {
        PolicyFactory pf = new HtmlPolicyBuilder()
                .allowElements("a")
    ...
    @Test
    public void testScopingExitInNoContent() {
        PolicyFactory pf = new HtmlPolicyBuilder()
    ...
    @Test
    public void testScriptTagWithCommentBlockContainingHtmlCommentEnd() {
    ...
    @Test
    public void testNoscriptInAttribute() {
        PolicyFactory pf = new HtmlPolicyBuilder()
    ...
    public void testImg() {
        ...
        Assert.assertEquals(
                "aa<img>sdfdsf</img>dd",
                pf.sanitize(
                        "<img>sdfdsf</img>"));
    }
    
    private String apply(HtmlPolicyBuilder b) {
        return apply(b, EXAMPLE);
    }
    
    private String apply(HtmlPolicyBuilder b, String src) {
        String result = b.toFactory().sanitize(
                src, null,
                new Handler<String>() {
